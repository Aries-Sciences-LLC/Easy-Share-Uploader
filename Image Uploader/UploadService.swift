...
public enum UploadType: CaseIterable {
    case Google
    case Imgur
    case Dropbox
    case CatBox
...
public class UploadService: NSObject {
    ...
    public func upload(uploadType: UploadType, credentials: LoginSystem?) {
        ...
        case .Backendless:
            Backendless.sharedInstance()?.file.uploadFile(self.randomWord(wordLength: Int.random(in: 1...20)), content: mainImage.png!, response: { fileURL in
        ...
        case .Imgur:
            ...
            Alamofire.upload(multipartFormData: { multipartFormData in
                if let imageData = mainImage.jpeg {
